      ...
      <div className="about__inner">
        ...
        <div className="about__content">
          <div className="about-text">
            ...
            <p>
              {`As a frontend software developer, I enjoy creating responsive and interactive web applications with simple, yet visually appealing designs. Although my main expertise is working on the frontend, I am also familiar with backend tools and technologies including working with databases, RESTful APIs, and user authentication.`}
            </p>
